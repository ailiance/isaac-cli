import { IsaacRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/isaac/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<IsaacRulesToggles> {
	...
	return IsaacRulesToggles.create({ toggles: toggles })
}
