import type { ToggleAgentsRuleRequest } from "@shared/proto/isaac/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<IsaacRulesToggles> {
