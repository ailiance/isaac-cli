...
// 'Add to Isaac' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToIsaac(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToIsaac", request.selectedText, filePath, request.language)
