...
import { IsaacIgnoreController } from "./IsaacIgnoreController"
import "should"

describe("IsaacIgnoreController", () => {
	let tempDir: string
	let controller: IsaacIgnoreController
	...
	describe("Error Handling", () => {
		...
		it("should handle missing .diracignore gracefully", async () => {
			...
			try {
				const controller = new IsaacIgnoreController(emptyDir)
				await controller.initialize()
