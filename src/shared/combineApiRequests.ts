...
/**
 * Combines API request start and finish messages in an array of IsaacMessages.
 *
 ...
 * @returns A new array of IsaacMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: IsaacMessage[]): IsaacMessage[] {
	const combinedApiRequests: IsaacMessage[] = []
