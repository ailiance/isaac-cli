...
import { IsaacSyncStorage } from "./IsaacStorage"

export interface IsaacFileStorageOptions {
	/**
 ...
 */
export class IsaacFileStorage<T = any> extends IsaacSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "IsaacFileStorage", options?: IsaacFileStorageOptions) {
		super()
