 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "dirac.generatedMachineId"
 ...
 * This is updated to Isaac User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Isaac User ID.
