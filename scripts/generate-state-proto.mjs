 ...
 *
 * The generated proto content is written to proto/isaac/state.proto,
...
const STATE_PROTO_PATH = "proto/isaac/state.proto"
...
function parseSecretsKeys(sourceFile) {
	...
	for (const element of initializer.getElements()) {
		...
		// Skip prefixed keys like "dirac:diracAccountId"
		if (!key.includes(":")) {
			keys.push(key)
		}
	}
