...
import UseCustomPromptCheckbox from "@/features/settings/components/UseCustomPromptCheckbox"
	...
	return (
		<div className="flex flex-col gap-2">
			<BaseUrlField
				...
				onChange={(value: string) => handleFieldChange("lmStudioBaseUrl", value)}
			...
			<div className="text-xs text-description">
				...
				<div className="text-error">
					<span className="font-semibold">Note:</span> Isaac uses complex prompts and works best with Claude models.
