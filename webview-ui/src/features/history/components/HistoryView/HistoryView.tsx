...
const HistoryView = ({ onDone }: HistoryViewProps) => {
	const taskHistory = useHistoryStore((state) => state.taskHistory)
	...
	const totalTasksSize = useHistoryStore((state) => state.totalTasksSize)
	const setTotalTasksSize = useHistoryStore((state) => state.setTotalTasksSize)
